...
<div class="card">
    ...
    <div class="row justify-content-center">
		<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="d-block">Isi Kinerja OPD</label>
        ...
        <div class="col-sm-12 mb-4" style="background: #c3dbdd;padding: 15px;">
          ...
          <div class="form-group" >
				...
				<div class="pr-0 pl-0 pb-0">
					...
					<li class="mb-2" ><input type="radio" name="artikel[category]" value="3"  checked/> <?php echo $val["isi"];?>
